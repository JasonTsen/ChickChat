...
import 'package:chickchat/Controller/util.dart';
...
//                ),
  ...
  Future<void> _saveUserImageToFirebaseStorage(croppedFile) async {
    try {
      String takeImageURL = await FirebaseController.instance.sendImageToUserInChatRoom(croppedFile,widget.chatID);
  ...
  Future<void> _handleSubmitted(String text) async {
    try {
      ...
      await FirebaseController.instance.sendMessageToChatRoom(widget.chatID,widget.myID,widget.selectedUserID,text,messageType);
      await FirebaseController.instance.updateChatRequestField(widget.selectedUserID, messageType == 'text' ? text : '(Photo)',widget.chatID,widget.myID,widget.selectedUserID);
      await FirebaseController.instance.updateChatRequestField(widget.myID, messageType == 'text' ? text : '(Photo)',widget.chatID,widget.myID,widget.selectedUserID);
  ...
  Future<void> _getUnreadMSGCountThenSendMessage() async{
    try {
      int unReadMSGCount = await FirebaseController.instance.getUnreadMSGCount(widget.selectedUserID);
